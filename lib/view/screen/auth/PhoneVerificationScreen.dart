...
import 'package:store/controller/authController/PhonelVerificationController.dart';
...
class PhoneVerificationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<PhonelVerificationController>(
      init: PhonelVerificationController(),
      builder: (controller) {
        return Scaffold(
          body: Stack(
            children: [
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20),
                      ElevatedButton(
                         onPressed: controller.verifyCode_phone,
                      ...
                      TextButton(
                        onPressed: controller.isResendEnabled
                            ? () async {
                          await controller.resendCode_phone();
